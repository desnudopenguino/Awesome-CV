  ...
  \cventry
    ...
    {Mar 2017 - Jun 2018} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Tools used: Ansible, Apache, Asana, AWS resources, BitBucket, CodeIgniter, Git, HTML \& CSS, JavaScript/jQuery, Jira, Katalon Recorder, MetaBase, MySQL, PHP, Riot/Matrix, Shell Scripting, Terraform, Slack, Stripe, Twilio}
      \end{cvitems}
    }
