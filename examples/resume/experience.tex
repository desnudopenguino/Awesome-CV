...
%---------------------------------------------------------
  \cventry
    {Contract Developer} % Job title
    {American Fine Art Company/Top Drawer Media} % Organization
    {Spokane, WA} % Location
    {Oct 2014 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Flootie.com development}
        \begin{itemize}
        ...
        \end{itemize}
        \item {Managed and upgraded WordPress installations for Art Chowder, Top Drawer Media, and Northwest Aerospace News websites}
        \item {Built a new version of FlyFlicker.com}
